  ...
  for(i = 0;i<nrules;i++)
    {
      ...
      //      printf("### plhs[%d] %s index %d class %d\n",i,bp -> name, bp -> index,bp -> class);
      printf("%s\t",bp -> name); 
    }
  printf("\n");
}

static void print_pitems()
{
  int i = 0;
  bucket *bp;
  printf("print_pitems\n");
  ...
  for(i = 0;i<nitems;i++)
    {
      ...
      printf("%s\t",bp -> name);
      //      printf("### pitem[%d] %s index %d class %d\n",i,bp -> name, bp -> index,bp -> class);  
    }
  printf("\n");
}
...
pack_symbols(void)
{
    ...
    printf("### pack_symbols %s %s\n", v[start_symbol + 1] -> name,v[start_symbol + 2] -> name);
    printf("### pack_symbols %s\n", goal -> name);    
